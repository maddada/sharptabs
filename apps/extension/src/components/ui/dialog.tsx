...
const DialogContent = React.forwardRef<
    ...
    React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & { animated?: boolean }
    ...
    <DialogPortal>
        ...
        <DialogPrimitive.Content
            ...
            className={cn(
                ...
                // Do not try to override animate-in with animate-none. The animation
                // plugin's later rules win that cascade and can replay in Chrome popups.
                animated
            ...
            aria-description={props["aria-description"] || "Alert Dialog"}
            {...props}
        >
            {children}
...
>(({ className, ...props }, ref) => (
    <DialogPrimitive.Description ref={ref} className={cn("text-sm text-muted-foreground select-none", className)} {...props} />
));
