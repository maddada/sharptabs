...
export const AiFeaturesSection = ({ settings, updateSetting, isPremium, debouncedUpdateAutoOrganizePrompt }: AiFeaturesSectionProps) => {
        ...
        <section id="ai-features" className="scroll-mt-24 rounded-2xl bg-muted/40 p-6 shadow">
            ...
            <div className="relative mt-4 mb-4 items-center justify-between rounded-lg border p-3 shadow-sm">
                ...
                <input
                    ...
                    placeholder="AIza..."
                />
                {hasOwnApiKey && <div className="mt-2 text-xs text-green-600">API key saved. AI features are now available.</div>}
            </div>
            ...
            <div className="relative mt-6 items-center justify-between rounded-lg border p-3 shadow-sm">
                ...
                <textarea
                    ...
                    disabled={!settings.aiAutoOrganizeTabs || (!isPremium && !hasOwnApiKey)}
